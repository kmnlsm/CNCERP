		...
		/*first the cost of sales entry*/
				...
				$SQL = "INSERT INTO gltrans (	type,
										...
										VALUES ( 10,
												...
												'成本的" . $_SESSION['Items'.$identifier]->CustomerName . " - " . $OrderLine->ItemDescription . " x " . $OrderLine->Quantity . " @ " . $OrderLine->StandardCost . "',
												'" . $OrderLine->StandardCost * $OrderLine->Quantity . "')";
		...
		/*now the stock entry*/
				...
				$SQL = "INSERT INTO gltrans (type,
										...
										VALUES ( 10,
											...
											'商品的" . $_SESSION['Items'.$identifier]->CustomerName . " - " . $OrderLine->ItemDescription . " x " . $OrderLine->Quantity . " @ " . $OrderLine->StandardCost . "',
											'" . (-$OrderLine->StandardCost * $OrderLine->Quantity) . "')";
$GltransBalance[]=$SQL;
		...
		//Post sales transaction to GL credit sales
				...
				$SQL = "INSERT INTO gltrans (type,
										...
										VALUES ( 10,
											...
											'销售的" . $_SESSION['Items'.$identifier]->CustomerName . " - " . $OrderLine->ItemDescription . " x " . $OrderLine->Quantity . " @ " . $OrderLine->Price . "',
				...
				if ($OrderLine->DiscountPercent !=0){
					...
					$SQL = "INSERT INTO gltrans (type,
												...
												VALUES ( 10,
													...
													'折扣的" . $_SESSION['Items'.$identifier]->CustomerName . " - " . $OrderLine->ItemDescription . " @ " . ($OrderLine->DiscountPercent * 100) . "%',
			...
			if (($_SESSION['Items'.$identifier]->total + filter_number_format($_POST['TaxTotal'])) !=0) {
				$SQL = "INSERT INTO gltrans (	type,
											...
											VALUES ( 10,
												...
												'客户的" . $_SESSION['Items'.$identifier]->CustomerName . "',
				...
				if ($TaxAmount !=0 ){
					$SQL = "INSERT INTO gltrans (	type,
												...
												VALUES ( 10,
													...
													'税的" . $_SESSION['Items'.$identifier]->CustomerName . "',
													'" . (-$TaxAmount/$ExRate) . "')";
$GltransBalance[]=$SQL;
			...
			EnsureGLEntriesBalance(10,$InvoiceNo,$GltransBalance);
