	...
	/* If its a stock item .... Insert stock movements - with unit cost */
		...
		$SQL = "INSERT INTO stockmoves (stockid,
									...
									VALUES (
										...
										'" . $_SESSION['UserID'] . "',
										'" . $PeriodNo . "',
										'" . _('Reversal') . ' - ' . $_POST['SuppName'] . ' - ' . $GRN['orderno'] . "',
										'" . -$QtyToReverse . "',
										'" . $GRN['stdcostunit'] . "',
										'" . $NewQtyOnHand . "'
										)";
	...
	First the credit using the GLCode in the PO detail record entry*/
		...
		$SQL = "INSERT INTO gltrans (type,
								...
								VALUES (
									...
									'" . $PeriodNo . "',
									'" . $GRN['glcode'] . "',
									'" . _('GRN Reversal for PO') .": " . $GRN['orderno'] . " " . $_POST['SuppName'] . " - " . DB_escape_string($GRN['itemdescription']) . " x " . $QtyToReverse . " @ " . locale_number_format($GRN['stdcostunit'],$_SESSION['CompanyRecord']['decimalplaces']) . "',
									'" . -($GRN['stdcostunit'] * $QtyToReverse) . "')";
...
/*now the GRN suspense entry*/
		$SQL = "INSERT INTO gltrans (type,
							...
							VALUES (
								...
								. _('GRN Reversal PO') . ': ' . $GRN['orderno'] . " " . $_POST['SuppName'] . " - " . DB_escape_string($GRN['itemdescription']) . " x " . $QtyToReverse . " @ " . locale_number_format($GRN['stdcostunit'],$_SESSION['CompanyRecord']['decimalplaces']) . "',
								'" . $GRN['stdcostunit'] * $QtyToReverse . "'
								)";
