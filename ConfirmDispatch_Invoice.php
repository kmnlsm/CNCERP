				...
				if(!$IsAsset) { // its a normal stock item
					...
					if($DisposalRow['accumdepn']!=0) {
						$SQL = "INSERT INTO gltrans (type,
											...
											VALUES (
												...
												'" . $_SESSION['Items'.$identifier]->CustomerName . ' - ' . $OrderLine->StockID . ' ' . _('accumulated depreciation disposal') . "',
					...
					if($DisposalRow['cost']!=0) {
						$SQL = "INSERT INTO gltrans (
									...
									$PeriodNo . "','" .
									$DisposalRow['costact'] . "','" .
									$_SESSION['Items'.$identifier]->CustomerName . " - " . $OrderLine->ItemDescription . ' ' . _('cost disposal') . "','" .
									-$DisposalRow['cost'] . "')";
					...
					if($DisposalRow['cost']-$DisposalRow['accumdepn']!=0) {
						$SQL = "INSERT INTO gltrans (type,
											...
											VALUES (
												...
												'" . $_SESSION['Items'.$identifier]->CustomerName . " - " . $OrderLine->ItemDescription . ' ' . _('net book value disposal') . "',
					...
					$SQL = "INSERT INTO gltrans (type,
										...
										VALUES (
											...
											'" . $PeriodNo . "',
											'" . $DisposalRow['disposalact'] . "',
											'" . $_SESSION['Items'.$identifier]->CustomerName . " - " . $OrderLine->ItemDescription . ' ' . _('asset disposal proceeds') . "',
