...
function clickDate($f) {
	//Calendar(this.name, localStorage.DateFormat);
	//Weberp: Y/m/d   ; bootstrap-datepicker:yyy/mm/dd
	switch (localStorage.getItem("DateFormat"))
{
 ...
 break;
 case "Y-m-d":
 $bootstrapdateformat = "yyyy-mm-dd";
 break;
 case "Y/m/d":
 $bootstrapdateformat = "yyyy/mm/dd";
 break;
 default:
 $bootstrapdateformat = "yyyy年mm月dd";
 break;
}
